...
public class OcReport extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RPTANGGAL = intent.getStringExtra("RPTANGGAL");
        RPCL_IN = intent.getStringExtra("RPCL_IN");
        ...
        helper = new ArkaHelper(OcReport.this);
        currentTime();
        currentDate();
        generateData();
        ...
        datePicker = new DatePickerDialog(OcReport.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(OcReport.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(OcReport.this);

                    TextView tvTitle = new TextView(OcReport.this);
                    ...
                    Intent intent = new Intent(OcReport.this, EmployeeActivity.class);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(OcReport.this);
    ...
    public void generateData(){
        ...
        inputForm.setVALUE(RPTANGGAL);
        inputForms.add(inputForm);

        inputForm = new InputForm();
        inputForm.setICON(getResources().getDrawable(R.drawable.ic_clock));
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Jam Masuk");
        inputForm.setVALUE(RPCL_IN);
        inputForms.add(inputForm);

        inputForm = new InputForm();
        inputForm.setICON(getResources().getDrawable(R.drawable.ic_clock));
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Jam Keluar");
        inputForm.setVALUE(RPCL_OUT);
        inputForms.add(inputForm);

        inputForm = new InputForm();
        inputForm.setICON(getResources().getDrawable(R.drawable.ic_clock));
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Lama Kerja");
        inputForm.setVALUE(RPWORKHOUR);
        inputForms.add(inputForm);
