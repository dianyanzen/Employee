...
public class Activity_Clockin extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(Activity_Clockin.this);
        currentTime();
        currentDate();
        generateData();
        ...
        datePicker = new DatePickerDialog(Activity_Clockin.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(Activity_Clockin.this);
                ...
                if (inputForms.get(i).getTYPE().equals("DATEPICKER")) {
                    ...
                    builder = new AlertDialog.Builder(Activity_Clockin.this);

                    TextView tvTitle = new TextView(Activity_Clockin.this);
                    ...
                    Intent intent = new Intent(Activity_Clockin.this, EmployeeActivity.class);
                    startActivityForResult(intent, 1000);
                } else if (inputForms.get(i).getTYPE().equals("PROJECT")) {
                    Intent intent = new Intent(Activity_Clockin.this, ProjectActivity.class);
                    startActivityForResult(intent, 1000);
                }
            }
        });
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(Activity_Clockin.this);
    ...
    public boolean onMyLocationButtonClick() {
        ...
        Toast.makeText(Activity_Clockin.this, "Address : "+addressLine, Toast.LENGTH_SHORT).show();
