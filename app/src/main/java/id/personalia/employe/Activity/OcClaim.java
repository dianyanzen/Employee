...
public class OcClaim extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(OcClaim.this);

        currentDate();
        generateData();

        toolbar = (Toolbar) findViewById(R.id.toolbar);
        setTitle(getResources().getString(R.string.detail_claim));
        ...
        datePicker = new DatePickerDialog(OcClaim.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(OcClaim.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(OcClaim.this);

                    TextView tvTitle = new TextView(OcClaim.this);
                    ...
                    Intent intent = new Intent(OcClaim.this, EmployeeActivity.class);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(OcClaim.this);
