...
public class SearchTravelActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(SearchTravelActivity.this);
        ...
        setTitle(getResources().getString(R.string.search_travel));
        ...
        datePicker = new DatePickerDialog(SearchTravelActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(SearchTravelActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(SearchTravelActivity.this);

                    TextView tvTitle = new TextView(SearchTravelActivity.this);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(SearchTravelActivity.this);
