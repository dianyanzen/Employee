...
/**
 * Created by dianyanzen on 22/09/17.
 */

public class Activity_Clockout extends AppCompatActivity
        implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(Activity_Clockout.this);
        currentTime();
        currentDate();
        generateData();
        ...
        datePicker = new DatePickerDialog(Activity_Clockout.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(Activity_Clockout.this);
                ...
                if (inputForms.get(i).getTYPE().equals("DATEPICKER")) {
                    ...
                    builder = new AlertDialog.Builder(Activity_Clockout.this);

                    TextView tvTitle = new TextView(Activity_Clockout.this);
                    ...
                    Intent intent = new Intent(Activity_Clockout.this, EmployeeActivity.class);
                    startActivityForResult(intent, 1000);
                } else if (inputForms.get(i).getTYPE().equals("PROJECT")) {
                    Intent intent = new Intent(Activity_Clockout.this, ProjectActivity.class);
                    startActivityForResult(intent, 1000);
                }
            }
        });
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(Activity_Clockout.this);
    ...
    public void generateData(){
        ...
        inputForm.setVALUE("Tidak ada keterangan");
        inputForms.add(inputForm);
    ...
    public boolean onMyLocationButtonClick() {
        ...
        Toast.makeText(Activity_Clockout.this, "Address : "+addressLine, Toast.LENGTH_SHORT).show();
