...
public class SearchReportActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(SearchReportActivity.this);
        currentTime();
        currentDate();
        generateData();
        ...
        setTitle(getResources().getString(R.string.search_report));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SearchReportActivity.this, Activity_Main.class);
                intent.putExtra("FragmentNM", "Report");
        ...
        datePicker = new DatePickerDialog(SearchReportActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(SearchReportActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(SearchReportActivity.this);

                    TextView tvTitle = new TextView(SearchReportActivity.this);
                    ...
                    Intent intent = new Intent(SearchReportActivity.this, EmployeeActivity.class);
                    startActivityForResult(intent, 1000);
                }else if(inputForms.get(i).getTYPE().equals("PROJECT")){
                    Intent intent = new Intent(SearchReportActivity.this, ProjectActivity.class);
                    startActivityForResult(intent, 1000);
                }
            }
        });
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(SearchReportActivity.this);
