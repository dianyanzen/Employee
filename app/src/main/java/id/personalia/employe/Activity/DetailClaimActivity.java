...
public class DetailClaimActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(DetailClaimActivity.this);
        ...
        setTitle(getResources().getString(R.string.new_claim));
        ...
        datePicker = new DatePickerDialog(DetailClaimActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(DetailClaimActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(DetailClaimActivity.this);

                    TextView tvTitle = new TextView(DetailClaimActivity.this);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(DetailClaimActivity.this);
    ...
    public void generateData(){
        ...
        inputForm.setVALUE("Transportasi/Berobat/Dll");
        inputForms.add(inputForm);
        ...
        inputForm.setTYPE("EDITTEXT");
        inputForm.setLABEL("Jumlah");
        inputForm.setVALUE("Rp.");
        inputForms.add(inputForm);
    }
