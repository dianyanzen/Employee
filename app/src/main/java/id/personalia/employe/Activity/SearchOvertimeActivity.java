...
public class SearchOvertimeActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(SearchOvertimeActivity.this);
        ...
        setTitle(getResources().getString(R.string.search_overtime));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SearchOvertimeActivity.this, Activity_Main.class);
                intent.putExtra("FragmentNM", "Overtime");
        ...
        datePicker = new DatePickerDialog(SearchOvertimeActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(SearchOvertimeActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(SearchOvertimeActivity.this);

                    TextView tvTitle = new TextView(SearchOvertimeActivity.this);
                    ...
                    Intent intent = new Intent(SearchOvertimeActivity.this, EmployeeActivity.class);
                    startActivityForResult(intent, 1000);
                }else if(inputForms.get(i).getTYPE().equals("PROJECT")){
                    Intent intent = new Intent(SearchOvertimeActivity.this, ProjectActivity.class);
                    startActivityForResult(intent, 1000);
                }
            }
        });
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(SearchOvertimeActivity.this);
