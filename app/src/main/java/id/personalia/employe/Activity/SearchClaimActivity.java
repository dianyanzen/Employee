...
public class SearchClaimActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(SearchClaimActivity.this);
        ...
        setTitle(getResources().getString(R.string.search_claim));
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SearchClaimActivity.this, Activity_Main.class);
                intent.putExtra("FragmentNM", "Claim");
        ...
        datePicker = new DatePickerDialog(SearchClaimActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(SearchClaimActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(SearchClaimActivity.this);

                    TextView tvTitle = new TextView(SearchClaimActivity.this);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(SearchClaimActivity.this);
