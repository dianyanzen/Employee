...
public class OcAttendance extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    SearchView sv;
    String ATTTANGGAL,ATTDESCRIP,ATTLAMA,ATTDIAJUKAN,ATTSTATUS;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ATTTANGGAL = intent.getStringExtra("ATTTANGGAL");
        ATTDESCRIP = intent.getStringExtra("ATTDESCRIP");
        ATTLAMA = intent.getStringExtra("ATTLAMA");
        ATTDIAJUKAN = intent.getStringExtra("ATTDIAJUKAN");
        ATTSTATUS = intent.getStringExtra("ATTSTATUS");
        setContentView(R.layout.activity_detail_attendance);

        helper = new ArkaHelper(OcAttendance.this);
        currentTime();
        currentDate();
        generateData();
        ...
        setTitle(getResources().getString(R.string.detail_attendance));
        ...
        datePicker = new DatePickerDialog(OcAttendance.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(OcAttendance.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(OcAttendance.this);

                    TextView tvTitle = new TextView(OcAttendance.this);
                    ...
                    Intent intent = new Intent(OcAttendance.this, EmployeeActivity.class);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(OcAttendance.this);
    ...
    public void generateData(){
        ...
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Deskripsi");
        inputForm.setVALUE(ATTDESCRIP);
        inputForms.add(inputForm);
