...
public class DetailOvertimeActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helper = new ArkaHelper(DetailOvertimeActivity.this);
        ...
        setTitle(getResources().getString(R.string.new_overtime));
        ...
        datePicker = new DatePickerDialog(DetailOvertimeActivity.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(DetailOvertimeActivity.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(DetailOvertimeActivity.this);

                    TextView tvTitle = new TextView(DetailOvertimeActivity.this);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(DetailOvertimeActivity.this);
