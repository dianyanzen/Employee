...
public class OcOvertime extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OTTANGGAL = intent.getStringExtra("OTTANGGAL");
        OTDIAJUKAN = intent.getStringExtra("OTDIAJUKAN");
        OTKETERANGAN = intent.getStringExtra("OTKETERANGAN");
        ...
        helper = new ArkaHelper(OcOvertime.this);
        ...
        setTitle(getResources().getString(R.string.detail_overtime));
        ...
        datePicker = new DatePickerDialog(OcOvertime.this, R.style.ArkaCalendar, this, year, month, day);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                LinearLayout linearLayout = new LinearLayout(OcOvertime.this);
                ...
                if(inputForms.get(i).getTYPE().equals("DATEPICKER")){
                    ...
                    builder = new AlertDialog.Builder(OcOvertime.this);

                    TextView tvTitle = new TextView(OcOvertime.this);
                    ...
                    Intent intent = new Intent(OcOvertime.this, EmployeeActivity.class);
    ...
    public void popupBuilderString(View v, int position){
        ...
        popupEditText = new EditText(OcOvertime.this);
    ...
    public void generateData(){
        ...
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Keterangan");
        inputForm.setVALUE(OTKETERANGAN);
        inputForms.add(inputForm);
        ...
        inputForm.setICON(getResources().getDrawable(R.drawable.ic_clock));
        inputForm.setTYPE("VIEWTEXT");
        inputForm.setLABEL("Jumlah Jam Lembur");
        inputForm.setVALUE(OTJUMLAH);
        inputForms.add(inputForm);
