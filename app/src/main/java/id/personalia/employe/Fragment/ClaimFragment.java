...
public class ClaimFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        ClaimAdapter = new ClaimAdapter(getActivity(), R.layout.claim_list_layout, Claims);
    ...
    public void dummyData(){
        ...
        Claim = new Claim();
        Claim.setCLTTANGGAL("2017-05-06");
        Claim.setCLNMPENGAJU("TRANSPORTASI");
        Claim.setCLDESKRIKSI("Dian Yanzen");
        Claim.setCLJUMLAH("Rp. 1,000,000.00");
        Claim.setCLSTATUS("Menunggu");
        Claims.add(Claim);
