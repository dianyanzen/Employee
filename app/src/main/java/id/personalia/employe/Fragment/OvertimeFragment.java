...
public class OvertimeFragment extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        OvertimeAdapter = new OvertimeAdapter(getActivity(), R.layout.overtime_list_layout, Overtimes);
    ...
    public void dummyData(){
        ...
        Overtime.setOTTANGGAL("2017-05-06");
        Overtime.setOTDIAJUKAN("Dian Yanzen");
        Overtime.setOTKETERANGAN("Begadang");
        Overtime.setOTJAMLEMBUR("20:00");
        Overtime.setOTKALKULASI("24:00");
        Overtime.setOTJUMLAH("4jam");
        Overtime.setOTSTATUS("Menunggu");
