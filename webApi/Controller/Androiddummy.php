...
class Androiddummy extends REST_Controller {
    ...
    function index_post() {
        ...
        //print_r($this->input->post());
			...
			if($cek > 0){
			$query = $this->db->query("
			SELECT A.*, C.role_name, D.position_name, E.user_group_description,E.user_group_id,E.is_admin FROM tb_m_employee A 
